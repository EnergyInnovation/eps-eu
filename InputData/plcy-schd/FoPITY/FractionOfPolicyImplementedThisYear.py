...
PolicyElements = (
  ...
  (("trans fuel economy standards","passenger","LDVs"),
    ...
    ("Schedule 2",(2022,0),(2025,0),(2035,1),(2050,1)),
    ("Schedule 3",(2022,0),(2025,0),(2035,1),(2050,1)),
  ),
  ...
  (("trans fuel economy standards","freight","LDVs"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0),(2027,0),(2050,1)),
    ("Schedule 3",(2022,0),(2027,0),(2050,1)),
  ),
  ...
  (("trans ZEV minimum","passenger","LDVs"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0.215),(2023,0.223),(2030,0.538),(2035,1),(2050,1)),
    ("Schedule 3",(2022,0.215),(2023,0.223),(2030,0.538),(2035,1),(2050,1)),
  ),
  (("trans ZEV minimum","passenger","HDVs"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0),(2025,0.474),(2030,0.779),(2035,0.8737),(2040,1),(2050,1)),
    ("Schedule 3",(2022,0),(2025,0.474),(2030,0.779),(2035,0.8737),(2040,1),(2050,1)),
  ),
  ...
  (("trans ZEV minimum","freight","LDVs"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0.055),(2030,0.538),(2035,1),(2050,1)),
    ("Schedule 3",(2022,0.055),(2030,0.538),(2035,1),(2050,1)),
  ),
  (("trans ZEV minimum","freight","HDVs"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0),(2025,0.09),(2030,.359),(2035,0.628),(2040,1),(2050,1)),
    ("Schedule 3",(2022,0),(2025,0.09),(2030,.359),(2035,0.628),(2040,1),(2050,1)),
  ),
  ...
  (("elec renewable portfolio standards"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0),(2023,0.464),(2035,1),(2050,1)),
    ("Schedule 3",(2022,0),(2023,0.464),(2030,1),(2050,1)),
  ),
  (("elec ban new power plants","hard coal es"),
    ("Schedule 1",(2022,0),(2023,1),(2050,1)),
    ("Schedule 2",(2022,0),(2029,0),(2030,1),(2050,1)),
    ("Schedule 3",(2022,0),(2029,0),(2030,1),(2050,1)),
  ),
  ...
  (("elec early retirement","hard coal es"),
    ("Schedule 1",(2022,0),(2023,1),(2050,1)),
    ("Schedule 2",(2022,0),(2023,1),(2030,1),(2050,1)),
    ("Schedule 3",(2022,0),(2023,1),(2030,1),(2050,1)),
  ),
  ...
  (("bldgs new component fuel shifting","heating","urban residential"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,1),(2025,0.97),(2030,0.83),(2035,0.83),(2040,0.74),(2045,0.73),(2050,0.66)),
  ...
  (("bldgs new component fuel shifting","heating","commercial"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,1),(2025,0.97),(2030,0.81),(2035,0.83),(2040,0.80),(2045,0.72),(2050,.65)),
    ("Schedule 3",(2022,0.33),(2023,0.4),(2030,1),(2050,1)),
  ),
  (("bldgs new component fuel shifting","cooling and ventilation","urban residential"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,1),(2025,0.97),(2030,0.83),(2035,0.83),(2040,0.74),(2045,0.73),(2050,0.66)),
    ("Schedule 3",(2022,1),(2025,0.97),(2030,0.83),(2035,0.83),(2040,0.74),(2045,0.73),(2050,0.66)),
  ),
  ...
  (("bldgs new component fuel shifting","cooling and ventilation","commercial"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,1),(2025,0.97),(2030,0.81),(2035,0.83),(2040,0.80),(2045,0.72),(2050,.65)),
    ("Schedule 3",(2022,1),(2025,0.97),(2030,0.81),(2035,0.83),(2040,0.80),(2045,0.72),(2050,.65)),
  ),
  ...
  (("indst cement measures"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0),(2030,0),(2035,1),(2050,1)),
    ("Schedule 3",(2022,0),(2030,0),(2035,1),(2050,1)),
  ),
  ...
  (("indst CCS","refined petroleum and coke 19","energy related emissions"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0),(2024,0),(2050,1)),
    ("Schedule 3",(2022,0),(2024,0),(2050,1)),
  ),
  ...
  (("cross carbon tax","transportation sector"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0.223),(2023,0.218),(2024,0.114),(2025,0.173),(2026,0.21),(2027,0.235),(2028,0.239),(2029,0.285),(2030,0.342),(2031,0.38),(2032,0.415),(2033,0.494),(2034,0.569),(2035,0.64),(2036,0.707),(2037,0.771),(2038,0.832),(2039,0.889),(2040,0.943),(2041,0.958),(2042,0.971),(2043,0.982),(2044,0.992),(2045,1),(2046,0.974),(2047,0.948),(2048,0.922),(2049,0.896),(2050,0.87)),
    ("Schedule 3",(2022,0.223),(2023,0.218),(2024,0.114),(2025,0.173),(2026,0.21),(2027,0.235),(2028,0.239),(2029,0.285),(2030,0.342),(2031,0.38),(2032,0.415),(2033,0.494),(2034,0.569),(2035,0.64),(2036,0.707),(2037,0.771),(2038,0.832),(2039,0.889),(2040,0.943),(2041,0.958),(2042,0.971),(2043,0.982),(2044,0.992),(2045,1),(2046,0.974),(2047,0.948),(2048,0.922),(2049,0.896),(2050,0.87)),
  ),
  (("cross carbon tax","electricity sector"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0.368),(2023,0.364),(2024,0.278),(2025,0.327),(2026,0.373),(2027,0.41),(2028,0.429),(2029,0.483),(2030,.545),(2031,.587),(2032,0.606),(2033,0.628),(2034,0.649),(2035,0.666),(2050,1)),
    ("Schedule 3",(2022,0.368),(2023,0.364),(2024,0.278),(2025,0.327),(2026,0.373),(2027,0.41),(2028,0.429),(2029,0.483),(2030,.545),(2031,.587),(2032,0.606),(2033,0.628),(2034,0.649),(2035,0.666),(2050,1)),
  ),
  (("cross carbon tax","residential buildings sector"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0),(2026,0),(2027,0.159),(2028,0.233),(2029,0.305),(2030,0.374),(2031,0.44),(2032,0.503),(2033,0.564),(2034,0.622),(2035,0.677),(2036,0.73),(2037,0.781),(2038,0.83),(2039,0.876),(2040,0.92),(2041,0.938),(2042,0.955),(2043,0.971),(2044,0.986),(2045,1),(2046,0.991),(2047,0.983),(2048,0.974),(2049,0.965),(2050,0.956)),
    ("Schedule 3",(2022,0),(2026,0),(2027,0.159),(2028,0.233),(2029,0.305),(2030,0.374),(2031,0.44),(2032,0.503),(2033,0.564),(2034,0.622),(2035,0.677),(2036,0.73),(2037,0.781),(2038,0.83),(2039,0.876),(2040,0.92),(2041,0.938),(2042,0.955),(2043,0.971),(2044,0.986),(2045,1),(2046,0.991),(2047,0.983),(2048,0.974),(2049,0.965),(2050,0.956)),
  ),
 ...
 (("cross non BAU carbon tax border adjustment industry"),
  ...
  (("land forest management"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0),(2023,0),(2030,1),(2050,1)),
    ("Schedule 3",(2022,0),(2023,0),(2030,1),(2050,1)),
  ),
  ...
  (("geoeng direct air capture"),
    ("Schedule 1",(2022,0),(2050,1)),
    ("Schedule 2",(2022,0),(2030,0),(2031,1),(2040,1),(2041,0.85),(2042,0.8),(2050,0.8)),
    ("Schedule 3",(2022,0),(2030,0),(2031,1),(2040,1),(2041,0.85),(2042,0.8),(2050,0.8)),
  ),
